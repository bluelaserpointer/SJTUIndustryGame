...
public class Waypoint_Indicator_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (targetScript.toggleSetupOptions)
        {
            ...
            /*
            SerializedProperty property = serializedObject.FindProperty("camera_tag_name_array");
            EditorGUILayout.PropertyField(property, new GUIContent("Camera Tag Name(s)"), true);
            */
            #endregion

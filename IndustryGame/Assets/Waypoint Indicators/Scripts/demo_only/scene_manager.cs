...
public class scene_manager : MonoBehaviour
{
    ...
    */
    ...
    void OnEnable()
    {
        event_manager.onLoadScene += LoadLevel;
        event_manager.onCloseOptionScreenWithX += CloseOptionScreenManually;
    }
    ...
    void InstantiateStations()
    {
        ...
        //Each pre-scene spawning prefab must have a "reload.cs" attached to it
    ...
    void CloseOptionScreenManually()
    {
        ...
        event_manager.CloseOptionScreen();
    ...
    public void ToggleInstructions()
    {
        if (!instructionsWindowOpen) //If options window is closed, open it
        {
            ...
            event_manager.OpenOptionScreen();

            instructionsWindowGameObject = Instantiate(Resources.Load("Demo Only/UI/Intructions Window", typeof(GameObject)), transform.position, Quaternion.identity) as GameObject;
